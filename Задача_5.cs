...
Console.WriteLine("Получившийся после ввода количества строк массив:");
WriteArray(pascalTriangle);
TransformationPascalTriangle(pascalTriangle);
Console.WriteLine();
Console.WriteLine("Выведены строки треугольника Паскаля, в зависимости от количества строк:");
WriteArray(pascalTriangle);
